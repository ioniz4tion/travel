...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { description: @about.description, email: @about.email, image: @about.image, name: @about.name, phone: @about.phone }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { description: @about.description, email: @about.email, image: @about.image, name: @about.name, phone: @about.phone }
    assert_redirected_to about_path(assigns(:about))
  end
