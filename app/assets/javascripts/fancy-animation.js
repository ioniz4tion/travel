...
window.onload = function() {
	...
	tl.to(w[0], 0, {x: -75, y: -75, xPercent: -50, yPercent: -50})
	  ...
	  .insert(new TweenMax.to(w[0], 1, {x: 75, yoyo: true, repeat: -1, ease: Sine.easeInOut, delay: .5}))
	  .insert(new TweenMax.to(w[0], 1, {y: 75, yoyo: true, repeat: -1, ease: Sine.easeInOut}));
