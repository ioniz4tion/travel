window.onload = function() {
	...
	tl.to(w[0], 0, {x: -75, y: -75, xPercent: -50, yPercent: -50})
	  ...
	  .insert(new TweenMax.to(w[1], 3.75, {x: 111, yoyo: true, repeat: -1, ease: Sine.easeInOut, delay: 3.75/2}))
	  .insert(new TweenMax.to(w[1], 3.75, {y: 111, yoyo: true, repeat: -1, ease: Sine.easeInOut}))
